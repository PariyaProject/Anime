...
This guide covers deploying the Vue.js frontend in this repository.
...
The build output will be in the repository `dist/` directory.
...
- Check logs: `pm2 logs anime-frontend`
- Review this guide
