...
- [ ] **Task 2.1**: 创建 `scripts/update-agent.sh`
  - 定时检查 GHCR 镜像 digest
  - 对比本地和远程镜像
  - 自动拉取和重启
  - 清理旧镜像
...
- [ ] **Task 3.1**: 创建 `.github/workflows/build-and-push.yml`
...
1. Dockerfile (1.1)
2. .dockerignore (1.3)
3. docker-compose.yml (1.4)
4. Dockerfile.update-agent (1.2)
5. update-agent.sh (2.1)
6. 测试 Update Agent (2.2)
7. GitHub Actions (3.1, 3.2)
8. CI/CD 测试 (3.3)
9. 文档编写 (4.1, 4.2, 4.4)
10. 端到端测试 (5.1-5.4)
